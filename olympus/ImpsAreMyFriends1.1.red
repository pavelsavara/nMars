...
; Here's hoping the paper Anders tested on the hill this week wasn't meant for me...
; I didn't have time to figure out how to "stamp" my paper this week.

; Maybe I should have entered the cmp-scanning, light-speed bombing, pit-trapping, replicating 
; imp spiral with the three pass core clear and gate.  And it does windows.  Oh well.
