...
;dist /240 rnd 0
;author Dave Hillis
;strategy - Experimenting with P-space
;assert CORESIZE==55440
;Tells the starting postion for a given 
;round in the fixed sequence.
;The number of ties against the sleeper 
;(minus the round number)
;is the answer = starting position/240
;
PIN 5339
; I think these constants are superfluous
_RESULT equ #0          
_ROUNDS equ #2236       
_BOOT   equ #2237
_FRIEND equ #2240
...
;these are the constants that matter
_SLEEP          equ #555
S_CODE          equ #200
_COUNTER        equ # 193  
_DIST           equ #12; holds the distance from first rnd
WRAP            equ   110
THE_RND equ #0  ; report the starting position for round 0
