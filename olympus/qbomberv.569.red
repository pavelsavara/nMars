...
;sorry for the non-entry last round
;too busy working on paper for college
;this is an old program of mine.. i changed it a little
...
split2   spl mid1    ;execute with style
         spl mid2
         spl tail
...
tail     mov  <QB+QS*33,>QB+QS*33+QD
         ...
         mov  datz, 0       ;only one process allowed to enter
         
;stuff here     
; TORNADO BOMBER

step    equ     -45
away    equ     1000 ; not really
gate1   equ     (gate-4)
