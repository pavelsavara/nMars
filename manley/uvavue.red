;redcode-b
;name You Wouln't Let It Lie!
;author Scott Manley
;strategy 0.6 c Incendiary bomber -> core clear
;strategy Pspaced paper, better boot code 
;strategy Wilkinson Benchmark score 121.7
;strategy Percentage record	    30/37/33
