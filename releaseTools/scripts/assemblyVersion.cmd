...
echo [assembly: AssemblyCompany("nMars")]>> %~dp0\..\..\nMars\nMars.RedCode\Properties\VersionInfo.cs 
echo [assembly: AssemblyProduct("nMars - Corewars MARS for .NET ")]>> %~dp0\..\..\nMars\nMars.RedCode\Properties\VersionInfo.cs 
echo [assembly: AssemblyVersion("%VER%.%BUILDREV%")]>> %~dp0\..\..\nMars\nMars.RedCode\Properties\VersionInfo.cs 
echo [assembly: AssemblyFileVersion("%VER%.%BUILDREV%")]>> %~dp0\..\..\nMars\nMars.RedCode\Properties\VersionInfo.cs 
echo [assembly: AssemblyCopyright("Pavel Savara - http://sourceforge.net/projects/nmars")]>> %~dp0\..\..\nMars\nMars.RedCode\Properties\VersionInfo.cs 
