...
;           to store in pspace. The hand I decide to show is stored in he
;           B-field of instruction 'my_hand'.
;---BEGIN-VARIABLE-PART-----------------------------------------------------
start	jmz.b	start,	your_hand
	sne.ab	STONE,	your_hand
	mov.ab	PAPER,	my_hand
	sne.ab	SCISSORS,your_hand
	mov.ab	STONE,	my_hand
	sne.ab	PAPER,	your_hand
