...
;strategy    
;strategy       This verions has the late addition of some handshaking code
;strategy       to permit it to beat itself 100% of the time.  I'm pretty sure
;strategy       that this is not keeping with the spirit of the challenge although
;strategy       it doesn't "peek" or try and influence the opponent other than
;strategy       by pure chance (ie- an opponent is using the same locations/keys)
