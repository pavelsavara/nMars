...
;name Recycled Paper
;author Planar
;strategy Slightly modified version of Head or Tail
;strategy Tailored for round 6 of the Redcode Maniacs Tournament
;strategy The retroQ scan is perfect for this purpose.
;strategy I modified the paper to be more anti-imp.
;strategy This should give me about 3200 points, so I'm going
;strategy to get about 80% this round (hopefully).
;assert 1
