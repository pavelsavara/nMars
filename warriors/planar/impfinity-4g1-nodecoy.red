...
This is my entry for the maniacs tournament.  Impfinity is the only
successful warrior I've ever written (yet).  I simply removed the 51
decoy instructions to make it fit into the 50-instruction limit.

-- Damien

;redcode-94
;name Impfinity v4g1-nodecoy
;author Planar
;strategy boot,imp,stone,clear
;strategy   This version is without decoy.
