...
; to clear the core. If one is killed, the other clears core by itself.
; Only two processes are used until the coreclear, where all 8 are needed. 
; Thus, being hit by a SPL bomb will probably kill this, but it won't ; feel it until the coreclear tries to start.
